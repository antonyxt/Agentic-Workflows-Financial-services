...
class SWIFTMessage(BaseModel):
    ...
    def set_agent_perspectives(self, perspectives:str):
        self.agent_perspectives = perspectives
    ...
    def get_chain_analysis(self)-> str:
        return self.chain_analysis
    
    def get_agent_perspectives(self)-> str:
        return self.agent_perspectives
